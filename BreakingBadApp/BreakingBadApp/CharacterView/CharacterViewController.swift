...
extension CharacterViewController: CharacterViewControllerProtocol {
    ...
    func showLabelsText(from string: [String]) {
        self.title = string[0]
        nameLabel.text = string[0]
        birthDayLabel.text = string[1]
        occupationLabel.text = string[2]
        statusLabel.text = string[3]
        nickNameLabel.text = string[4]
        appearanceLabel.text = string[5]
        portrayedLabel.text = string[6]
        categoryLabel.text = string[7]
        betterCallSaulAppearanceLabel.text = string[8]
    }
}
